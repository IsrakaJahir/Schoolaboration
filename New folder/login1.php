...
<body>
    ...
    <h2 style="margin-left: 50px;margin-top: 140px; font-size: 30px; font-family: Bookman old style; font-weight: 600;letter-spacing: 0.1rem; color: darkmagenta;">One app to<br>manage all the </h2>
        ...
        <h4 style="margin-left: 150px; font-family: bookman old style; font-size:15px; font-style: italic; color: dimgrey; font-weight: 300;">DUnlock your potential with our app</h4>
        </div>
<div class="right">
